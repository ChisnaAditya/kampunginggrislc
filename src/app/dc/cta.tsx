...
export default function CTA() {
  return (
    ...
    >
      {/* <div className="lg:absolute lg:top-1/4 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 w-full lg:max-w-6xl border-[1px] bg-primaryLC/40 hover:border-black/10 rounded-lg"> */}
      <Image
        alt="logo lc"
