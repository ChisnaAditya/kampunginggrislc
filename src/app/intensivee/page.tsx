    ...
    <div className="">
      <nav className="z-[2] hidden lg:flex lg:items-center w-full h-[100px] bg-black text-white text-[18px] font-normal">
        ...
        <ul className="flex justify-center items-center gap-6 basis-4/6">
          <Link href="#overview">
            <p className="hover:text-primaryLC">Gambaran Umum</p>
          </Link>
          <Link href="#benefits">
            <p className="hover:text-primaryLC">Keuntungan</p>
          </Link>
          <Link href="#keseruan">
            <p className="hover:text-primaryLC">Galeri</p>
          </Link>
          <Link href="#alumni">
            <p className="hover:text-primaryLC">Alumni Kami</p>
          </Link>
          <Link href="#tutor">
            <p className="hover:text-primaryLC">Tutor Kami</p>
          </Link>
          <Link href="#goals">
            <p className="hover:text-primaryLC">Target Kami</p>
          </Link>
      ...
      <div className="flex flex-col lg:flex-row w-full lg:h-screen bg-white">
        <div className="z-[2] container flex flex-col justify-center basis-1/2 py-5 lg:pl-[150px] ">
          <Image
            alt="Intensive English Program - jumbotron mobile"
            src="/hero-iep.png"
            width={720}
            height={676}
            ...
            priority
          />
          <h1 className="text-[28px] lg:text-[48px] text-black font-extrabold leading-tight lg:leading-[58.09px]">
            {" "}
            <span className="italic text-primaryLC">
              Upgrade English Skills{" "}
            </span>{" "}
            untuk Peluang yang Lebih Baik
          </h1>
          <p className="text-[16px] lg:text-[32px] text-black font-light lg:leading-[38.73px] py-5">
            Investasi terbaik untuk masa depan yang lebih cerah, belajar bahasa
      ...
      <div className="lg:px-[150px] mt-5 grid grid-cols-6">
        <div className="container col-span-6">
          <div className="overview">
            <article className="">
              <h1 id="overview"></h1>
              <h2 className="text-[18px] lg:text-[24px] font-bold text-primaryLC">
                Gambaran Umum
              </h2>
              <h2 className="text-[24px] leading-[1.3em] lg:text-[32px] font-bold">
                Apakah kamu <span className="italic">gap year student</span>{" "}
                yang ingin membuat waktu <span className="italic">break</span>{" "}
                kamu produktif dan bermanfaat untuk masa depan kamu?
                <br />
                <span className="italic">Here’s your chance!</span>
              </h2>
              <p className="text-[16px] lg:text-[18px] mt-5">
                Atau kamu adalah profesional atau karyawan di suatu perusahaan
                yang ingin{" "}
                <span className="italic">upgrade English skills</span> untuk
                meraih peluang karier yang lebih baik?
              </p>
              <br />
              <p className="text-[16px] lg:text-[18px] italic">
                <span className="font-bold">Intensive English Program</span> is
                exactly what you need.
              </p>
              <br />
              <p className="text-[16px] lg:text-[18px]">
                Program ini dirancang khusus untuk kamu yang ingin meningkatkan{" "}
                <span className="italic">English skills</span> dari{" "}
                <span className="italic">basic</span>.
              </p>
              <br />
              <p className="text-[16px] lg:text-[18px]">
                LC menawarkan metode{" "}
                <span className="italic">English boarding course</span> yang
                dilengkapi dengan <span className="italic">English area</span>{" "}
                yang memungkinkan kamu tidak hanya belajar teori, namun juga
                praktik <span className="italic">speaking</span> langsung
                sehingga kamu percaya diri mengaplikasikan{" "}
                <span className="italic">English skills</span> kamu dalam
                kehidupan sehari-hari dengan efektif.
              </p>
              <br />
              <p className="text-[16px] lg:text-[18px]">
                Tersedia berbagai pilihan paket, mulai dari program 2 minggu,
                program 1 bulan, program 2 bulan, hingga program 3 bulan.
              </p>
              <br />
              <p className="text-[16px] lg:text-[18px]">
                Bergabunglah dengan LC dan upgrade{" "}
                <span className="italic">English skills</span> kamu untuk masa
          ...
          <div className="benefit">
            <article className="mb-4">
              <h1 id="benefits"></h1>
              <h2 className="text-[18px] lg:text-[24px] font-bold text-primaryLC mt-10">
                Keuntungan
              </h2>
              <h2></h2>
              <p></p>
          ...
          <div className="alumni">
            <article className="">
              <h1 id="alumni"></h1>
              <h2 className="text-[18px] lg:text-[24px] text-primaryLC font-bold mt-10">
                Alumni Kami
              </h2>
              <h2></h2>
              <p></p>
          ...
          <div className="Tutor">
            <article className="">
              <h1 id="tutor"></h1>
              <h2 className="text-[18px] lg:text-[24px] text-primaryLC font-bold">
                Tutor Kami
              </h2>
              <h2></h2>
              <p></p>
      ...
      <div className="container flex flex-col items-center justify-center py-20">
        <article className="prose text-center mb-10 lg:mb-20">
          ...
          <h1 className="text-[24px] lg:text-[32px]">
            <span className="italic">Frequently Asked Questions</span> <br />
            (FAQ){" "}
          </h1>
        </article>
        <FAQ />
