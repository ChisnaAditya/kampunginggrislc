...
export default function goals() {
    ...
    function Card(prop: cardProps) {
        return (
            <div className='flex flex-col justify-center items-center my-1 lg:my-8'>
                ...
                <p className='h-56 w-full -mt-5 rounded-xl border-[2px] text-[16px] lg:text-[18px] px-5 py-10'>{HTMLReactParser(prop.goal)}</p>
            </div>
        )
    }
    return (
